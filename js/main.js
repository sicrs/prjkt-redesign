...
window.onscroll = () => {
    if (isElementInViewport(document.querySelector('.title')) === true) {
        tabbar.foundation_.activateTab(0)
    } else {
